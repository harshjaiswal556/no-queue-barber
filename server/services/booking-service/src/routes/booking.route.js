...
const { createBooking, getBookingByCustomerId, cancelBookingByBookingId, getBookingsByShopId, updateBookingStatus } = require('../controllers/booking.controller');
...
router.route('/status/:booking_id').put(protect, updateBookingStatus);
